 ...
 */
function cobalt_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['cobalt_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cobalt sample setting'),
  '#default_value' => theme_get_setting('cobalt_example'),
